...
const content = [
    {
        ...
        content: (
            <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--orange-500),var(--yellow-500))] text-white">
                <img src="/projectsrc/sheila.webp" alt="Sheila – AI-Enabled Home Assistant" />
            </div>
        ),
    },
    {
        ...
        content: (
            <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--orange-500),var(--yellow-500))] text-white">
                <img src="/projectsrc/parcar.webp" alt="ParCar – Smart Parking IoT Platform" />
            </div>
        ),
    },
    {
        ...
        content: (
            <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--orange-500),var(--yellow-500))] text-white">
                <img src="/projectsrc/ai-netra.webp" alt="AI-Netra – Real-Time Object Detection for Accessibility" />
            </div>
        ),
    },
    {
        ...
        content: (
            <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--orange-500),var(--yellow-500))] text-white">
                <img src="/projectsrc/urban-agro.webp" alt="Urban Agro – Intelligent IoT-Based Agricultural Advisor" />
            </div>
        ),
    },
    {
        ...
        content: (
            <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--orange-500),var(--yellow-500))] text-white">
                <img src="/projectsrc/CNN-Model-Visualizer.webp" alt="Embedded CNN and Model Visualizer Software" />
            </div>
        ),
    },
];
