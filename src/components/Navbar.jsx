...
//               hover:text-taupe text-[21px] font-medium font-mova uppercase tracking-[3px] cursor-pointer nav-links text-small mobile-menu-item`} // Added class for mobile menu item
...
//               src={menu}
//               alt="menu"
//               className={`w-[34px] h-[34px] object-contain cursor-pointer ${toggle ? 'hidden' : ''}`}
//               onClick={() => setToggle(!toggle)}
//             />
//           )}
//         </div>
    ...
    <nav className={`${styles.paddingX} w-full flex items-center py-2 fixed top-0 z-20 bg-flashWhite sm:opacity-[0.97] xxs:h-[12vh]`}>
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div className="sm:hidden flex flex-1 w-screen justify-end items-center">
          ...
          ) : null} {/* Updated this line to conditionally render based on the 'toggle' state */}
        </div>
      </div>
    </nav>
  );
