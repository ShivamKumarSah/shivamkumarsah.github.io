    ...
    return (
        ...
        >
            <div className="relative flex w-full flex-1 scale-y-100 items-center justify-center isolate z-0 ">
                ...
                <div className="absolute inset-auto z-50 h-20 w-[28rem] -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>
                <motion.div
                    initial={{ width: "8rem" }}
                    ...
                    className="absolute inset-auto z-30 h-20 w-64 -translate-y-[3rem] rounded-full bg-cyan-400 blur-2xl"
                ></motion.div>
                <motion.div
                    initial={{ width: "15rem" }}
                    ...
                    className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[3.5rem] bg-cyan-400 "
                ></motion.div>

                <div className="absolute inset-auto z-40 h-20 w-full -translate-y-[6rem] bg-slate-950 "></div>
            </div>
